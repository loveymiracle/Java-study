...
public class Member {
	...
	public Member(int mno, String id, String password, String name, String gender, int age, String email,
			String phone, String address, String hobby, Date birthday, Date enrolldate) {
		super();
		this.mno = mno;
		this.id = id;
