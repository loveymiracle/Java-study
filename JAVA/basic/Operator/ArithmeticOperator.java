...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		System.out.println(a / b); // / : 나눗
		System.out.println(a / 3); // 10 / 3 = 3, int type으로 소수점 버려짐!
		System.out.println(a / 3.0);       // 소수점 출력방법 1 - double로 3.0 사용 
		System.out.println((double)a / 3); // 소수점 출력방법 2 - int값 중 나를 double로 캐스팅! 
		System.out.println(a / (double)3); 
		System.out.println((double)(a / 3)); // 안되는 표현!!! a/3을 실행하고 캐스트함으로 잘못 
...
//		System.out.println(a / 0); // java.lang.ArithmeticException
		...
		System.out.println(pi + i); // float + int = (큰거)float
