...
public class CompareOperator {
	public static void main(String[] args) {
		...
		// https://www.javastring.net/java/string/pool 참고할 것
		String str1 = "안녕하세요?"; // string pool
		String str2 = "안녕하세요?"; // string pool
		String str3 = new String("안녕하세요?"); // heap에 저장 되는 값
		...
		// -> 문자열 비교시에는 String.equals라는 메소드 활용할 것!! ✭✭✭✭✭
		...
		System.out.println(str1.contains(str4)); // 안녕하세요?에 안녕이 있는지 확인 
		System.out.println("안녕하세요?".contains("하이")); // false 
		
		// 결론!! 문자열 비교는 ==로 하면 안된다. equals를 활용해야 한다!!
	}
}
