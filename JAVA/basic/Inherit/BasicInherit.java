...
public class BasicInherit extends Object{
	...
	public static void main(String[] args) {
		// Object 활용법 : 모든 type을 대체해서 활용할 수 있다.
		// 부모(조상)의 type으로 자식의 type을 대체해서 활용할 수 있다. 단, 자식의 기능은 활용할 수 없다.
		Object obj1 = new Object();
		Object obj2 = new String();
		Object obj3 = new Date();
		Object obj4 = new BasicInherit();
		BasicInherit obj5 = new BasicInherit();
		
		// getClass : 클래스의 다양한 정보를 알 수 있는 메소드, 일반 사용자 용도는 아니다.
		// reflection (리플렉션)에 해당하는 기술 https://hudi.blog/java-reflection/
		// Class의 이름을 출력
		...
		// Class의 부모를 출력하는 방법
		System.out.println(obj1.getClass().getSuperclass()); // null -> root임으로 부모(조상)이 없다.
		...
		System.out.println(((Date)obj3).getTime()); // 객체 casting 단축 표현
		// 위에 문법을 풀어 써보면 
		Date date = (Date)obj3;
		long time = date.getTime();
		System.out.println(time);
		
		// ❏ 참고 var 사용법 = Java 11버전 이상만 활용 가능! (현재 8버전)
		// - var는 기본형의 type을 정하지 않고, 선언된 값의 type으로 대체하는 type(=익명 type)
		// -> 멤버 변수로는 활용할 수 없고, 로컬 변수로만 제약적으로 활용 가능
		var value1 = 5;
		var value2 = 3.14;
		var value3 = 518928308098509L;
