...
// 요구사항 : json 파일 양식을 읽어 1 ~ 10 위 까지의 이름, 누적 관객수를 출력

//-----------------------------------------------------
//1위, 미션임파서블, 누적 관객수 : null
//2위, 마이 웨이, 누적 관객수 : null
//3위, 셜록홈즈, 누적 관객수 : null
//4위, 퍼펙트 게임, 누적 관객수 : null
//5위, 프렌즈, 누적 관객수 : null
//6위, 라이온 킹, 누적 관객수 : null
//7위, 오싹한 연애, 누적 관객수 : null
//8위, 극장판 포켓몬스터 베스트 위시「비크티니와 백의 영웅 레시라무」, 누적 관객수 : null
//9위, 앨빈과 슈퍼밴드3, 누적 관객수 : null
//10위, 극장판 포켓몬스터 베스트 위시 「비크티니와 흑의 영웅 제크로무」, 누적 관객수 : null
//-----------------------------------------------------
...
public class Parsing {
	...
	public static void main(String[] args) {
		String array1[] = text.split("\\["); // [는 특수문자로 '\' 를 붙여줘야 한다.
		...
		// 컬렉션 으로 Key-Value 형태로 데이터를 분리 하는 과정
...
//				System.out.println(name + " : " + value);
	...
	// ※ 파싱이 필요한 경우 손으로 짜면 안되고 외부 API를 통해 정확한 파싱이 가능하다.
}
